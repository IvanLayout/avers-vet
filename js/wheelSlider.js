;(function($) {
    ...
    slider.children.on('click', function(e) {

        if (slider.working) return;

        var index = $(this).index();

        if (index === slider.active.index) return;

        el.goToSlide(index);

        slider.settings.onSlideClick.call(el, index);
        ...
        */
        ...
        el.goToNextSlide = function(e, fromSync) {
    ...
    slider.settings.onSlideNext.call(el, slider.active.index, fromSync)

}

el.goToPrevSlide = function(e, fromSync) {
    ...
    slider.settings.onSlidePrev.call(el, slider.active.index, fromSync)
        ...
        $el.data('wheelSlider', {
            ...
            next: function(fromSync) {
                el.goToNextSlide(null, fromSync)
            },

            prev: function(fromSync) {
                el.goToPrevSlide(null, fromSync)
            },
